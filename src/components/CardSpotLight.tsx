...
const ProjectIcon: React.FC<{ projectType: CardSpotlightProps["projectType"] }> = ({ projectType }) => {
  ...
  switch (projectType) {
    ...
    case "app":
      return <CubeIcon className="h-6 w-6 sm:h-8 sm:w-8 text-purple-500 mr-2" />;
    default:
      return <FileTextIcon className="h-6 w-6 sm:h-8 sm:w-8 text-purple-500 mr-2" />;
  }
};
...
export default function CardSpotlight({
  ...
  return (
    <div className="group bg-gray-50 rounded-lg border border-gray-200 p-6 hover:border-purple-500/50 transition-colors">
