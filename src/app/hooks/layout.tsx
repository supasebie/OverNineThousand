...
// These pages document a third-party package (@thibault.sh/hooks) and mirror its official
// docs, so they stay out of search results rather than compete with the original.
export const metadata: Metadata = {
  title: "@thibault.sh/hooks reference",
