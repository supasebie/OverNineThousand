      ...
      <Card className="p-8 text-center">
        ...
        <button
          ...
          className={`w-48 h-48 rounded-full mb-6 transition-all ${
            isActive ? "bg-purple-500 scale-95" : "bg-purple-400 hover:bg-purple-500"
          }`}
        >
        ...
        <div>
          <button onClick={resetTaps} className="text-sm text-gray-600 hover:text-purple-500 transition-colors">
            Reset
          </button>
        </div>
      </Card>
