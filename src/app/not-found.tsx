    ...
    <div className="relative min-h-screen bg-white text-gray-800 font-mono">
      ...
      <div className="relative max-w-4xl mx-auto px-4 py-8 sm:px-6 sm:py-12">
        <div className="flex items-center gap-2 mb-8 text-purple-500">
          ...
          <span className="text-sm">OverNineThousand.com ~ error</span>
        </div>

        <div className="space-y-6">
          <div>
            <div className="text-sm text-gray-500 mb-2">→ status --check</div>
            <h1 className="text-4xl font-bold text-purple-500 mb-2 flex items-center">
              {text}
              <span className="w-3 h-8 bg-purple-500/50 ml-2 animate-pulse" />
            </h1>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
            ...
            <div className="flex gap-3">
              <Button onClick={() => router.back()} variant="outline" className="text-purple-500 hover:text-purple-600">
                cd ..
                <br />
