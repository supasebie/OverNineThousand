      ...
      <div className="relative max-w-4xl mx-auto px-4 py-6 sm:px-6 sm:py-8">
        <article className="bg-gray-50 p-8 rounded-lg border border-gray-200">
          <header className="mb-8">
            <h1 className="text-4xl font-bold text-purple-600 mb-4">{post.title}</h1>
          ...
          <div
            className="prose max-w-none prose-purple prose-pre:bg-gray-100 prose-pre:border prose-pre:border-gray-200 prose-code:text-purple-600"
