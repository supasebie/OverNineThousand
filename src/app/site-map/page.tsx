    ...
    <div className="relative min-h-screen bg-white text-gray-800 font-mono">
      <div className="relative max-w-4xl mx-auto px-4 py-8 sm:px-6 sm:py-12">
        <div className="flex items-center gap-2 mb-8 text-purple-500">
          ...
          <span className="text-sm">OverNineThousand.com ~ sitemap</span>
        </div>

        <div className="mb-8">
          <div className="text-sm text-gray-500 mb-2">→ ls --sitemap</div>
          <h1 className="text-3xl font-bold mb-2 text-purple-500">Sitemap</h1>
        ...
        <div className="grid gap-6">
          ...
          <div className="mt-12">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-purple-500/50 hover:bg-purple-50 transition-colors"
            >
